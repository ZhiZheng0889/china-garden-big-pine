    ...
    <section className={styles.section}>
      ...
      {!hideButton && (
        <div className="py-3">
          <Link
            to="/checkout"
            className={`duration-200 ease-out block text-center p-3 md:p-2 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded mt-3  focus:outline outline-2 outline-offset-2 outline-red-600`}
            onClick={() =>
              typeof setIsCheckoutOpen === "function"
